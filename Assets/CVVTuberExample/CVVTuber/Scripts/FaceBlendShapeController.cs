    ...
    public class FaceBlendShapeController : FaceAnimationController
    {
        ...
        public override void LateUpdateValue()
        {
            ...
            if (enableMouth)
            {
                ...
                {
                    FACE_DEF.SetBlendShapeWeight(49, MouthOpenParam * 100);
                }
                else if (MouthOpenParam >= 0.25f)
                {
                    FACE_DEF.SetBlendShapeWeight(49, MouthOpenParam * 80);
                }
                else
                {
                    FACE_DEF.SetBlendShapeWeight(49, 0);
                }
            }
        }
        ...
        public override void Setup()
        {
            ...
            NullCheck(FACE_DEF, "SK_MINA_HEAD_01");
        }
